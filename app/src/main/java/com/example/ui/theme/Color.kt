...
// Vibrant Palette Brand Colors (From Design Spec)
val VibrantPurple = Color(0xFF6750A4)
val VibrantPurpleLight = Color(0xFFEADDFF)
val VibrantPurpleDark = Color(0xFF21005D)
val VibrantPurpleAccent = Color(0xFFD0BCFF)

val VibrantSkyBlue = Color(0xFF005FB0)
val VibrantSkyBlueContainer = Color(0xFFD1E1FF)
val VibrantSkyBlueDark = Color(0xFF001D49)

val VibrantCoral = Color(0xFFBA1A1A)
val VibrantCoralContainer = Color(0xFFFFDAD6)
val VibrantCoralDark = Color(0xFF410002)

val VibrantRose = Color(0xFF9C4146)
val VibrantRoseContainer = Color(0xFFFFD8E4)
val VibrantRoseDark = Color(0xFF3B071E)

val VibrantLavender = Color(0xFF6750A4)
val VibrantLavenderContainer = Color(0xFFE8DEF8)
val VibrantLavenderDark = Color(0xFF1D192B)

val VibrantAzure = Color(0xFF006399)
val VibrantAzureContainer = Color(0xFFCDE5FF)
val VibrantAzureDark = Color(0xFF001D35)

// File Type Colors for Badges and Cookie Icons
val FolderColor = Color(0xFF6750A4)
val ArchiveZipColor = Color(0xFF005FB0)
val Archive7zColor = Color(0xFF6750A4)
val ArchiveTarColor = Color(0xFF7D5260)
val ArchiveRarColor = Color(0xFFB3261E)
...
val AmoledDarkScheme = darkColorScheme(
    ...
    primaryContainer = Color(0xFF2B1F54),
    onPrimaryContainer = Color(0xFFEDE7F6),
    ...
    onSurfaceVariant = Color(0xFFD0D0DC),
    outline = Color(0xFF383844)
)

...
// MagicOS skin: Honor-style white (light) / black (dark) backgrounds and
// surfaces. Selected via the OS type setting; only the surfaces are taken
// (see withMagicOsSurfaces) so every accent palette works under MagicOS -
// the blue primary below is just the default pairing, not a fixed override.
val MagicOsLightScheme = lightColorScheme(
    ...
    // Soft gray page so the white cards/tiles pop, MagicOS-settings style.
    ...
    surfaceContainerHighest = Color(0xFFE3E5EC),
...
val MagicOsDarkScheme = darkColorScheme(
    primary = Color(0xFFAAC7FF),
    onPrimary = Color(0xFF002F67),
    primaryContainer = Color(0xFF0A59F7),
    onPrimaryContainer = Color.White,
    inversePrimary = Color(0xFF0A59F7),
    secondary = Color(0xFFBEC6DC),
    onSecondary = Color(0xFF283141),
    secondaryContainer = Color(0xFF3E4759),
    onSecondaryContainer = Color(0xFFDAE2F9),
    tertiary = Color(0xFFDFBBE0),
    ...
    surfaceContainerHigh = Color(0xFF17181D),
    surfaceContainerHighest = Color(0xFF222329),
